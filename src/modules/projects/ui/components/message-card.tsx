  ...
  return (
    ...
    >
      <div className='flex items-center gap-2 pl-2 mb-2'>
        <Image src='/logo.svg' alt='Lovable' width={18} height={18} className='shrink-0' />
        <span className='text-sm font-medium'>Lovable</span>
        <span className='text-xs text-muted-foreground opacity-0 transition-opacity group-hover:opacity-110'>
